 ...
 *******************************************************************************/
/*******************************************************************************
 * This java application takes clinic data input in CSV format and creates a
 * Clinical Document Architecture(CDA).
 *
 * Organization:
 *  Georgia Institute of Technology, Interoperability and Integration Innovation Lab (I3L)
 *  http://www.i3l.gatech.edu/
 *
 * @technical Advisor: Dr. Myung Choi
 *
 * @domain Advisor: Dr. Mark Braunstein
 *
 * @author:	Sungwoo Han
 *
 * @version	1.0
